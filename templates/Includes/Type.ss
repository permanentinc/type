...
<div id="typeSettings" class="js-load-type-settings" data-api="{$BaseHref}type_api/load">
    ...
    <div id="typeSettings" class="type" data-save-type-settings="$Link('SaveTypeSettings')"
        data-load-type-settings="$Link('LoadTypeSettings')" data-save-css="$Link('SaveCSS')"
        data-save-js="$Link('SaveJS')">

        <a href="#" class="js-toggle-type-settings"><svg width="107" height="54" viewBox="0 0 107 54"
